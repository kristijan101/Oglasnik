...
namespace Oglasnik.Services.Common
{
    public static class CountyServiceExtensions
    {
        ...
        public static Task<IPagedList<ICounty>> GetAsync(this ICountyService countyService, IPagingParameters paging, ISortingParameters sorting)
        {
        ...
        /// <param name="paging">A class instance that implements <see cref="IPagingParameters"/>, holds paging data.</param>
        /// <returns>Returns <see cref="Task{IPagedList{ICounty}}"/></returns>
        public static Task<IPagedList<ICounty>> GetAsync(this ICountyService countyService, IPagingParameters paging)
        {
